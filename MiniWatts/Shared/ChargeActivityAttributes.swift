...
///
/// iOS 16 compatibility: `LiveActivityIntent` is iOS 17-only, so the base
/// conformance is `AppIntent` (iOS 16) and the `LiveActivityIntent` refinement is
/// added for iOS 17 and later. On iOS 16 the End button is simply not drawn —
/// the Lock Screen activity can still be cleared by hand.
nonisolated struct EndChargeActivityIntent: AppIntent {
...
@available(iOS 17.0, *)
extension EndChargeActivityIntent: LiveActivityIntent {}
