...
final class PowerMonitor: ObservableObject {
    ...
    @Published private(set) var devices: [ExternalBatteryDevice] = []
    ...
    @Published var showsLiveActivityWhileCharging: Bool {
    ...
    @Published var liveActivityMetric: LiveActivityMetric {
        didSet {
