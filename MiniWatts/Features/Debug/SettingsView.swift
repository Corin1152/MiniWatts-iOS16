...
struct SettingsView: View {
    ...
    var body: some View {
        // iOS 16 compatibility: with `ObservableObject` the projected value of
        // `@EnvironmentObject` is the bindings collection itself, so the
        // `@Bindable` local copies the iOS 17 build needed are gone.
        NavigationStack {
            ZStack {
