...
struct BatteryWidgetView: View {
    ...
    var body: some View {
        ...
        content(palette)
            // iOS 16 compatibility: `containerBackground(for:)` is iOS 17-only.
            // On iOS 16 a widget's content fills the whole background itself —
            // the small and medium views already draw their own canvas — so the
            // modifier is simply absent below iOS 17.
            .mwWidgetBackground(family: family) {
                switch family {
